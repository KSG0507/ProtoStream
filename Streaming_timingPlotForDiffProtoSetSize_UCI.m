...
if(runCode)
    ...
    for mcount = 1:nummValues
        ...
        [optimumW_PDSForTh,S_PDSForTh,setValue_PDSForTh] = ProtoDashStreamingWithThreshold_Variation2(Y,Y,m,kernelType,currTh,sigmaVal,meanInnerProductY,false,drLowerBound);
        ...
        if(runGreedyStreaming)
            ...
            streakStartTime = tic;
            [optimumW_PGSForTh,S_PGSForTh,setValue_PGSForTh] = ProtoGreedyStreamingWithThreshold_Variation2(Y,Y,m,kernelType,currTh,sigmaVal,meanInnerProductY,false,drLowerBound);
