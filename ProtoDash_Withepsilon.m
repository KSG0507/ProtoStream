function [currOptw,S,setValues,stageWeights,stageGradients] = ProtoDash_Withepsilon(X,Y,mTemp,epsilon, kernelType,varargin) 
    ...
    start = tic;
    objectiveDiff = Inf;
    while (sizeS < m && (objectiveDiff > epsilon))
        iterationTime = tic;
        iterNum = iterNum + 1;
        ...
        objectiveDiff = newCurrSetValue - currSetValue;
